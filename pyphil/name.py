...
# #from old.pyphil.convention import NamingConvention, NameComposition
#
...
#
#     @classmethod
#     def _verify(cls, ns: str):
#         if "|" in ns:
#             raise ValueError(f"invalid namespace '{ns}': path separator '|' found")
#         if ":" == ns or "::" in ns:
#             raise ValueError(f"invalid namespace '{ns}': empty namespaces forbidden")
#
#     @classmethod
#     def of(cls, ns: Union[str, None, "Namespace"]) -> "Namespace":
#         """
...
#         raise ValueError(f"can only create Namespace from string or None types (was type: {ns.__class__})")
#
#     @classmethod
...
#             parent: Union["Namespace", None, object] = _none,
...
#         self._parent = parent  # The parent of this namespace (Namespace or None); _none until computed
...
#         """
#         is_root returns True if self represents the unnamed Maya root namespace.
#
...
#         """
#         return not self.namespace().is_root()
#
#    def base(self) -> str:
#        """
...
#        """
#        if self._state < _decomposed:
#            self.namespace().str()  # also sets self._base
...
#
#     def short(self, namespace: Optional[bool] = None) -> str:
#         """
...
#                 return self.base()
#             raise ValueError(f"unsupported 'namespace' argument {namespace} passed to Name.short")
#
